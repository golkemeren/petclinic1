insert into users values ('user1','{{bcrypt}$2a$10$WpWTR/gxRncNT..z5df.oetAHWu3YleRXQ5ewe.LC.nt/p2k63kju',true);
insert into users values ('user2','{bcrypt}$2a$10$Ubjw.wAag3JGVCl1Ew2Qo.wUhCGvmcCIPccIC/AsmR50ZBM4KguI6',true);
insert into users values ('user3','{bcrypt}$2a$10$7.eaq4HtQJaAPp7LVgMuC.7eRYLx5UCChmLKwaSNcjHlXVehkENW.',true);

insert authorities values ('user1','ROLE_USER');
insert authorities values ('user2','ROLE_USER');
insert authorities values ('user2','ROLE_EDITOR');
insert authorities values ('user3','ROLE_USER');
insert authorities values ('user3','ROLE_EDITOR');
insert authorities values ('user3','ROLE_ADMIN');
